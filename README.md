...
2. Install [Node.js](https://nodejs.org/en/).
    ...
    2. At the time of writing this, I'm running version `v24.17.0`.
...
4. Install [Discord.js](https://discord.js.org/#/docs/main/stable/general/welcome) with `npm install discord.js`.
    ...
    2. At the time of writing this, I'm running version `14.26.4`.
5. Install [Websockets](https://github.com/websockets/ws) with `npm install ws`.
    ...
    2. At the time of writing this, I'm running version `8.21.0`.
6. Install [Axios](https://github.com/axios/axios) with `npm install axios`.
    1. We need this to fetch Steam avatars. 
    2. At the time of writing this, I'm running version `1.18.1`.
...
17. (Windows) Start the bot with `start.bat`.
...
4. There are comments to help you fill out the rest of the server config.
5. Restart the server.
    - If you've installed this onto the server before starting the Discord bot, it will get lua errors from websockets until you set up the bot.